...
<td><select name="aff_cloacker_cron_interval" id="aff_cloacker_cron_interval">
...
<tr>
<td>
	<form method="post" action="options-general.php?page=wp-affliate-cloacker%2Faffliate-cloacker-class.php">
...
<p>
<label><b><?php _e("Next Run",AFF_CLOACKER_TEXT_DOMAIN);?></b></label>
<label>
<?php
